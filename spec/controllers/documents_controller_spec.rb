...
describe DocumentsController do
  ...
  describe "GET new" do
    let(:document){ mock_model(Document) }
    it "redirects to a new document" do
      Document.stub(:create).and_return(document)
      get :new, {}, valid_session
      response.should redirect_to edit_document_path(document)
    end
  end
